      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="bg-white p-8 rounded-3xl border border-gray-200/80 shadow-sm space-y-4">
            <h2 className="text-2xl font-extrabold text-[#333333]">Who We Are</h2>
          ...
          <div className="bg-white p-8 rounded-3xl border border-gray-200/80 shadow-sm space-y-4">
            <h2 className="text-2xl font-extrabold text-[#333333]">What We Do</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#333333] text-white p-8 rounded-3xl shadow-xl space-y-4">
            <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center">
        ...
        {/* CTA */}
        <div className="bg-white rounded-3xl p-8 border border-gray-200 text-center space-y-4 shadow-sm">
          <h3 className="text-2xl font-extrabold text-[#333333]">Have Questions About University Approvals or Admissions?</h3>
