...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 shadow-sm transition-all">
        {/* Top Bar Banner */}
        <div className="bg-[#333333] dark:bg-black text-white text-xs py-1.5 px-4 hidden md:block">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8 text-sm font-semibold text-[#333333] dark:text-gray-200">
              <Link
                to="/"
              ...
              <div className="relative" ref={collegeMenuRef}>
                ...
                {collegesDropdownOpen && (
                  <div className="absolute top-full left-0 w-[600px] -ml-20 mt-2 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 p-6 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="grid grid-cols-2 gap-x-6 gap-y-2.5">
                      {COLLEGE_NAV_ITEMS.map((item) => (
                        <Link
                          ...
                          className="p-2 rounded-xl hover:bg-[#FFE8EA] dark:hover:bg-gray-700 transition-colors flex flex-col group/item"
                        >
                          <span className="text-xs font-bold text-[#333333] dark:text-gray-100 group-hover/item:text-[#FA394A]">
                            {item.name}
                          </span>
                          <span className="text-[11px] text-[#999999] dark:text-gray-400">{item.loc}</span>
                        </Link>
                      ))}
                    </div>
                  </div>
              ...
              <div className="relative" ref={programMenuRef}>
                ...
                {programsDropdownOpen && (
                  <div className="absolute top-full left-0 w-[580px] -ml-28 mt-2 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 p-6 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                    <div className="flex justify-between items-center pb-3 border-b border-gray-100 dark:border-gray-700 mb-4">
                      <div className="flex items-center text-[#FA394A] font-bold text-sm">
                      ...
                      {displayPrograms.map((item) => {
                        ...
                        return (
                          <Link
                            ...
                            to={programRoute}
                            className="p-2.5 rounded-xl hover:bg-[#FFE8EA] dark:hover:bg-gray-700 transition-colors flex items-center justify-between group/p"
                          >
                            <span className="text-xs font-bold text-[#333333] dark:text-gray-100 group-hover/p:text-[#FA394A]">
                              {item.title}
                            </span>
                            <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 group-hover/p:bg-[#FA394A] group-hover/p:text-white">
                              {item.degreeType || 'PG'}
                            </span>
                          </Link>
                        );
              ...
              <button
                onClick={toggleTheme}
                className="ml-2 flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 dark:border-gray-700 hover:border-[#FA394A] hover:bg-[#FFE8EA] dark:hover:bg-gray-800 transition-all duration-300"
                aria-label="Toggle dark mode"
              >
                {theme === 'dark' ? (
                  <MoonStar className={`theme-icon ${theme === 'dark' ? 'theme-icon-rotate' : ''} w-5 h-5 text-[#FACC15]`} />
                ) : (
                  <SunMedium className={`theme-icon ${theme === 'dark' ? 'theme-icon-rotate' : ''} w-5 h-5 text-[#D97706]`} />
                )}
              </button>
            </nav>
              ...
              {user ? (
                <div className="relative" ref={userMenuRef}>
                  <button
                    ...
                    className="flex items-center space-x-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 py-2 px-3.5 rounded-xl transition-colors border border-gray-200 dark:border-gray-700"
                  >
                    <div className="w-7 h-7 rounded-full bg-[#FA394A] text-white font-bold text-xs flex items-center justify-center">
                      {user.name.charAt(0).toUpperCase()}
                    </div>
                    <span className="text-xs font-bold text-[#333333] dark:text-gray-100 max-w-[120px] truncate">
                      {user.name}
                    </span>
                  ...
                  {userDropdownOpen && (
                    <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 py-2 z-50">
                      <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-700">
                        <p className="text-xs font-bold text-[#333333] dark:text-gray-100">{user.name}</p>
                        <p className="text-[11px] text-gray-500 dark:text-gray-400 truncate">{user.email}</p>
                        <span className="inline-block mt-1 px-2 py-0.5 bg-[#FFE8EA] dark:bg-[#4a1d21] text-[#FA394A] font-bold text-[10px] rounded uppercase">
                          {user.role} Account
                        </span>
                      </div>
                      ...
                      <Link
                        ...
                        className="flex items-center px-4 py-2.5 text-xs font-semibold text-[#333333] dark:text-gray-200 hover:bg-[#FFE8EA] dark:hover:bg-gray-700 hover:text-[#FA394A] transition-colors"
                      >
                      ...
                      <button
                        onClick={logout}
                        className="w-full flex items-center px-4 py-2.5 text-xs font-semibold text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 transition-colors"
                      >
                ...
                <Link
                  to="/login"
                  className="text-[#333333] dark:text-gray-200 hover:text-[#FA394A] font-bold text-sm py-2 px-3 border border-gray-300 dark:border-gray-700 hover:border-[#FA394A] rounded-xl transition-colors"
                >
                  Login
                </Link>
              )}
            ...
            <div className="lg:hidden flex items-center space-x-3">
              <button
                onClick={toggleTheme}
                className="flex items-center justify-center w-9 h-9 rounded-full border border-gray-200 dark:border-gray-700 hover:border-[#FA394A] transition-all duration-300"
                aria-label="Toggle dark mode"
              >
                {theme === 'dark' ? (
                  <MoonStar className={`theme-icon ${theme === 'dark' ? 'theme-icon-rotate' : ''} w-4.5 h-4.5 text-[#FACC15]`} />
                ) : (
                  <SunMedium className={`theme-icon ${theme === 'dark' ? 'theme-icon-rotate' : ''} w-4.5 h-4.5 text-[#D97706]`} />
                )}
              </button>
              <Link
                to="/apply"
              ...
              <button
                ...
                className="p-2 rounded-xl text-[#333333] dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none"
      ...
      {mobileMenuOpen && (
        <div className="relative z-[999] lg:hidden">
          ...
          <div className="fixed inset-y-0 right-0 w-[85vw] max-w-xs bg-white dark:bg-gray-900 shadow-2xl flex flex-col justify-between overflow-y-auto p-6 z-[1000] border-l border-gray-200 dark:border-gray-800">
            <div>
              <div className="flex justify-between items-center pb-4 border-b border-gray-100 dark:border-gray-800 mb-6">
                ...
                <button
                  onClick={() => setMobileMenuOpen(false)}
                  className="p-1.5 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 hover:text-[#FA394A] transition-colors"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="space-y-3 text-sm font-bold text-[#333333] dark:text-gray-200">
                <Link
                  to="/"
                  className={`block py-2.5 px-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-[#FA394A] transition-colors ${
                    location.pathname === '/' ? 'bg-[#FFE8EA] dark:bg-[#4a1d21] text-[#FA394A]' : ''
                  }`}
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Home
                ...
                <Link
                  to="/about"
                  className={`block py-2.5 px-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-[#FA394A] transition-colors ${
                    location.pathname === '/about' ? 'bg-[#FFE8EA] dark:bg-[#4a1d21] text-[#FA394A]' : ''
                  }`}
                  onClick={() => setMobileMenuOpen(false)}
                >
                  About Us
                ...
                <div className="rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                  <button
                    ...
                    className="w-full flex justify-between items-center py-2.5 px-3 text-left hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-[#FA394A] transition-colors"
                  >
                    ...
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-200 ${
                        mobileCollegesOpen ? 'rotate-180 text-[#FA394A]' : 'text-gray-400 dark:text-gray-500'
                      }`}
                    />
                  </button>
                  {mobileCollegesOpen && (
                    <div className="bg-gray-50/80 dark:bg-gray-800/60 p-2 space-y-1 max-h-60 overflow-y-auto border-t border-gray-100 dark:border-gray-800">
                      {COLLEGE_NAV_ITEMS.map((item) => (
                        <Link
                          key={item.slug}
                          to={`/colleges/${item.slug}`}
                          className="block text-xs font-semibold text-gray-700 dark:text-gray-300 hover:text-[#FA394A] hover:bg-white dark:hover:bg-gray-700 p-2 rounded-lg transition-colors"
                          onClick={() => setMobileMenuOpen(false)}
                        >
                          {item.name}
                        </Link>
                ...
                <div className="rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-200 ${
                        mobileProgramsOpen ? 'rotate-180 text-[#FA394A]' : 'text-gray-400 dark:text-gray-500'
                      }`}
                    />
                  </button>
                  {mobileProgramsOpen && (
                      ...
                      {displayPrograms.map((item) => {
                        ...
                        return (
                          <Link
                            key={item.slug || item._id}
                            to={programRoute}
                            className="flex items-center justify-between text-xs font-semibold text-gray-700 dark:text-gray-300 hover:text-[#FA394A] hover:bg-white dark:hover:bg-gray-700 p-2 rounded-lg transition-colors"
                            onClick={() => setMobileMenuOpen(false)}
                          >
                            <span>{item.title}</span>
                            <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-200">
                              {item.degreeType || 'PG'}
                            </span>
                          </Link>
                        );
                ...
                <Link
                  to="/contact"
                  className={`block py-2.5 px-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-[#FA394A] transition-colors ${
                    location.pathname === '/contact' ? 'bg-[#FFE8EA] dark:bg-[#4a1d21] text-[#FA394A]' : ''
                  }`}
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Contact Us
            ...
            <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-800 space-y-3">
              ...
              {user ? (
                <>
                  <Link
                    to={user.role === 'admin' ? '/admin' : '/dashboard'}
                    className="w-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-[#333333] dark:text-gray-200 font-bold py-2.5 rounded-xl text-xs hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    <UserIcon className="w-4 h-4 mr-2" />
                    {user.role === 'admin' ? 'Admin Dashboard' : 'Student Dashboard'}
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center bg-red-50 dark:bg-red-950/40 text-red-600 dark:text-red-400 font-bold py-2.5 rounded-xl text-xs hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors"
                  >
                    <LogOut className="w-4 h-4 mr-2" />
                    Sign Out
                  </button>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Link
                    to="/login"
                    className="w-full text-center border border-gray-300 dark:border-gray-700 text-[#333333] dark:text-gray-200 font-bold py-2.5 rounded-xl text-xs hover:border-[#FA394A] transition-colors"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Login
                  </Link>
